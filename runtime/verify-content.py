...
def main() -> int:
    ...
    required_text = {
        ...
        ROOT / "NOTES.md": ("粒度层级固定", "三个不同问题", "A“专注隧道”", "纵向切片", "会话 3“模块、诊断与授权边界”", "共九项任务", "示范优先、局部补全和有界变化", "逐行旁注", "再激活型学习者", "建议路径", "活动文档保持最小且充分"),
        ...
        ROOT / "SESSION-PAGE-CONTRACT.md": ("2026-08-18", "唯一最终能力事实源 → 阶段 → 学习环", "本会话中文术语", "综合复习会话", "候选参考页", "模块、诊断与授权边界", "四阶段、十七环", "教学坡度", "教师示范 → 共同追踪输入/输出 → 局部补全", "再激活型学习者支持", "建议路径", "完整讲解", "逐行旁注", "不要求学习者从空白页自行设计"),
