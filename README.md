...
3. Complete the three distinct problems in order; each problem goes fully through the seven steps — orientation, underlying logic, Python details, prediction, core implementation, migration, and summary — and the page shows only one step at a time.
4. Once all nine tasks across the three problems are done, copy the full evidence on the summary page and interact with the teacher only once.
